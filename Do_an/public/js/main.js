...
const nameClient = document.getElementById("name-user-registration");
const phoneClient = document.getElementById("phone-user-registration");
const mailClient = document.getElementById("phone-user-registration")